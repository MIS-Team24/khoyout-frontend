...
const ServiceSkeleton = ({
  ...
  <div className="main-container">
    <Skeleton className="mb-8 mt-16 h-[40px] w-[100px] rounded bg-gray-100" />
                  ...
                  <Card className="rounded-2xl" key={`service-${i}`}>
                    <CardHeader className="gap-4">
                      <CardTitle className="font-medium text-foreground">
                        <Skeleton className="h-[28px] w-[200px] rounded bg-gray-100" />
                      </CardTitle>
                      <CardDescription className="text-xl text-secondary">
                        <Skeleton className="h-[28px] w-full rounded bg-gray-100" />
                      </CardDescription>
                    </CardHeader>
                    <CardFooter className="flex place-items-center justify-between">
                      <Skeleton className="h-[30px] w-[100px] rounded bg-gray-100" />
                      <Skeleton className="h-[35px] w-[80px] rounded bg-gray-100" />
                    </CardFooter>
                  </Card>
                ))}
            </div>
            ...
            <Card className="min-w-48 p-2" key={`team-member-${i}`}>
              <CardContent className="p-0 text-center">
                <div className="relative flex h-44 w-44 items-center justify-center rounded">
                  ...
                  <Image size={50} className="animate-pulse text-gray-300" />
                </div>
                <div className="mt-6 flex flex-col items-center">
                  <Skeleton className="mb-2 h-[28px] w-[100px] rounded bg-gray-100" />
                  <Skeleton className="h-[15px] w-[140px] rounded bg-gray-100" />
                </div>
              </CardContent>
            </Card>
          ))}
...
const ReviewsSkeleton = ({ reviewsLength }: { reviewsLength: number }) => (
  <section className="lg:mb-[4.25rem]">
    <div>
      <div className="mb-8">
        <Skeleton className="mb-8 h-[40px] w-[100px] rounded bg-gray-100" />
        <Skeleton className="h-[40px] w-[180px] rounded bg-gray-100" />
        <div className="mt-8 flex gap-4">
          <Skeleton className="h-[40px] w-[60px] rounded bg-gray-100" />
          <Skeleton className="h-[40px] w-[80px] rounded bg-gray-100" />
        </div>
      </div>
      <div>
            ...
            >
              <div className="flex gap-2">
                ...
                <div className="space-y-2">
                  <Skeleton className="h-[28px] w-[80px] rounded bg-gray-100" />
                  <Skeleton className="h-[50px] w-[60px] rounded bg-gray-100" />
                  <Skeleton className="h-[50px] w-[80px] rounded bg-gray-100" />
                </div>
              </div>
              <div className="space-y-2">
                <Skeleton className="h-[28px] w-full rounded bg-gray-100" />
    ...
    <Card className="px-8 py-10">
      <CardHeader className="p-0">
        <CardTitle className="text-[2.5rem] text-foreground">
          <Skeleton className="h-[80px] w-[200px] rounded bg-gray-100" />
        </CardTitle>
      </CardHeader>
      <CardContent className="p-0">
        <div className="my-8 flex place-items-center gap-4">
          <Skeleton className="h-[32px] w-[33px] rounded bg-gray-100" />
          <Skeleton className="h-[32px] w-[180px] rounded bg-gray-100" />
          <Skeleton className="h-[32px] w-[40px] rounded bg-gray-100" />
        </div>
        <div className="mb-6 flex gap-2">
          <Clock className="animate-pulse text-gray-200" />
          <Skeleton className="h-[28px] w-[377px] rounded bg-gray-100" />
        </div>
        <div className="mb-6 flex gap-2">
          <Clock className="animate-pulse text-gray-200" />
          <Skeleton className="h-[28px] w-[377px] rounded bg-gray-100" />
