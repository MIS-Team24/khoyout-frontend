              ...
              <div className="p-6">
                <div className="pb-4">
                  <div className="flex items-center justify-between">
                    ...
                    <p className="text-2xl font-normal leading-8">350 EGP</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <p className="text-base leading-6 text-[#49454F]">3500 EGP</p>
                </div>
              </div>
            </div>
            <div>
              <div className="">
                <div className="flex items-center justify-between pb-6">
                  ...
                  <p className="text-xl font-normal leading-8">350 EGP</p>
                </div>
                <div className="">
                  <Button
                    onClick={appear}
