...
const NavigationBar = forwardRef(function (_, ref) {
    ...
    return (
        ...
        >
            ...
            <div
                className=" mb-8 mt-16 lg:mt-0 flex flex-col lg:flex-row items-center justify-between pb-0 text-xl main-container">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <DropdownMenu>
                                    <DropdownMenuTrigger asChild>
                                        <Button
                                            className="cursor-pointer border-none bg-transparent text-black outline-none hover:bg-transparent">
                                            <ChevronDown/>
                                        </Button>
                                    </DropdownMenuTrigger>
